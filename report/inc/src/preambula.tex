...
\titleformat{name=\section,numberless}{\large\bfseries\filcenter}{}{0pt}{}
%\titleformat{\subsection}{\bfseries\centering}{\thesubsection}{14pt}{\bfseries}
...
% Список литературы
\makeatletter
\def\@label#1{#1 } % Изменение нумерации списка использованных источников
\makeatother
...
\newcommand{\img}[3] {
	\begin{figure}[h!]
		\center{\includesvg[height=#1]{inc/img/#2}}
		\caption{#3}
		\label{img:#2}
	\end{figure}
}
...
\newcommand{\png}[3] {
  \begin{figure}[h!]
    \center{\includegraphics[height=#1]{inc/img/#2.png}}
    \caption{#3}
    \label{img:#2}
  \end{figure}
}
...
% \usepackage{titlesec}
% \titleformat{\chapter}{\LARGE\bfseries}{\thechapter}{16pt}{\LARGE\bfseries}
% \titleformat{\section}{\Large\bfseries\centering}{\thesection}{16pt}{\Large\bfseries}
% \titleformat{\subsection}{\large\bfseries\centering}{\thesubsection}{16pt}{\large\bfseries}
% \titleformat{\subsubsection}{\bfseries\centering}{\thesubsubsection}{16pt}{\bfseries}
